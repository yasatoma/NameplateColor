...
namespace NameplateColor.Nameplates
{
    ...
    public class Nameplate : IDisposable
    {
        ...
        //private delegate IntPtr SetPlayerNameplateDelegate_Unmanaged(IntPtr playerNameplateObjectPtr, IntPtr namePtr);
        ...
        public void Dispose()
        {
            if (m_SetPlayerNameplateHook != null)
            {
                ...
                m_SetPlayerNameplateHook.Dispose();
                m_SetPlayerNameplateHook = null;
            }
